        ...
        <div class="overlay">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <h1>About Us</h1>
                        <p class="mb-0 bread"><a href="index.html" class="my-primary-color">Home</a> / About Us</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-6 ps-lg-4">
                    <h3 class="sub-title mb-2 my-primary-color">Objective</h3>
                    <h2 class="fw-semibold">We provide the best <span class="my-primary-color">tour facilities.</span>
                    </h2>
                    <p>Aperiam sociosqu urna praesent, tristique, corrupti condimentum asperiores platea ipsum ad arcu.
                        Nostrud. Esse? Aut nostrum, ornare quas provident laoreet nesciunt odio voluptates etiam, omnis.
                        Change the visual order of specific flex items with a handful of order utilities. We only
                        provide options for making an item first or last.</p>
                    <div class="row g-4">
                        <div class="col-sm-6">
                            <div class="inner-contain">
                                ...
                                <div>
                                    <h3 class="mb-0">Safety First Always</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="inner-contain bg-dif">
                                <div>
                                    <img src="assets/images/guide.svg" alt="">
                                </div>
                                <div>
                                    <h3 class="mb-0">Trusted Travel
                                        Guide</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="inner-contain bg-dif">
                                <div>
                                    <img src="assets/images/experienc.svg" alt="">
                                </div>
                                <div>
                                    <h3 class="mb-0">Expertise And
                                        Experience</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="inner-contain ">
                                <div>
                                    <img src="assets/images/time-save.svg" alt="">
                                </div>
                                <div>
                                    <h3 class="mb-0">Time and Stress
                                        Savings</h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-4 pt-2">
                        <a class="btn1" href="javascript:void(0);" data-bs-target="#enquire"
                            data-bs-toggle="modal">Enquiry Now</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="inner-contain inner-diff">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-4 col-3">
                                <div class="img-contain">
                                    <svg height="512" viewBox="0 0 64 64" width="512" xmlns="http://www.w3.org/2000/svg"><g id="success-hand-arrow_up-business-finance" data-name="success-hand-arrow up-business-finance"><path d="m59 34h-4a3.01 3.01 0 0 0 -2.82 2h-5.18a3.009 3.009 0 0 1 -3-3v-8a5 5 0 0 0 -10 0v11h-10a3.985 3.985 0 0 0 -2.62 7 3.951 3.951 0 0 0 0 6 3.985 3.985 0 0 0 2.62 7h.56a3.906 3.906 0 0 0 -.56 2 4 4 0 0 0 4 4h11a.66.66 0 0 0 .14-.01l13.08-1.87a3.006 3.006 0 0 0 2.78 1.88h4a3.009 3.009 0 0 0 3-3v-22a3.009 3.009 0 0 0 -3-3zm-7 24.13-13.07 1.87h-10.93a2 2 0 0 1 0-4h7v-2h-11a2 2 0 0 1 0-4h11v-2h-11a2 2 0 0 1 0-4h11v-2h-11a2 2 0 0 1 0-4h11a1 1 0 0 0 1-1v-12a3 3 0 0 1 6 0v8a5 5 0 0 0 5 5h5zm8 .87a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1-1v-22a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1z"/><path d="m61.8 10.4-6-8a1.041 1.041 0 0 0 -1.6 0l-6 8a1 1 0 0 0 .8 1.6h2v17a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-17h2a1 1 0 0 0 .8-1.6zm-3.8-.4a1 1 0 0 0 -1 1v17h-4v-17a1 1 0 0 0 -1-1h-1l4-5.33 4 5.33z"/><path d="m17 2a15 15 0 1 0 15 15 15.018 15.018 0 0 0 -15-15zm0 28a13 13 0 1 1 13-13 13.012 13.012 0 0 1 -13 13z"/><path d="m22 21a5.017 5.017 0 0 1 -4 4.9v1.1a1 1 0 0 1 -2 0v-1.1a5.017 5.017 0 0 1 -4-4.9 1 1 0 0 1 2 0 3 3 0 1 0 3-3 5 5 0 0 1 -1-9.9v-1.1a1 1 0 0 1 2 0v1.1a5.017 5.017 0 0 1 4 4.9 1 1 0 0 1 -2 0 3 3 0 1 0 -3 3 5 5 0 0 1 5 5z"/><path d="m2 38h4v2h-4z"/><path d="m8 38h8v2h-8z"/><path d="m2 44h4v2h-4z"/><path d="m8 44h8v2h-8z"/><path d="m2 50h4v2h-4z"/><path d="m8 50h8v2h-8z"/><path d="m2 56h4v2h-4z"/><path d="m8 56h8v2h-8z"/></g></svg>
